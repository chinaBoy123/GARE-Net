...
class Model(object):
    ...
    @autocast()
    def forward_emb(self, images, captions, lengths, image_lengths=None, boxes=None):
        ...
        img_emb = self.img_enc(images, boxes) # (128, 36, 1024)
        lengths = torch.Tensor(lengths).cuda()
        cap_emb = self.txt_enc(captions, lengths) # (128, 30, 1024)
    ...
    @autocast()
    # images:(128, 36, 2048), captions:(128, 30), lengths:(128), image_lengths:(128)
    def train_emb(self, images, captions, lengths, image_lengths=None, warmup_alpha=None, boxes=None):
        ...
        # img_emb:(128, 36, 1024), cap_emb:(128, 30, 1024)
        img_emb, cap_emb = self.forward_emb(images, captions, lengths, image_lengths=image_lengths, boxes=boxes)
