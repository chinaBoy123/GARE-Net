...
def main():
    ...
    parser.add_argument('--result1', default='/home/ubuntu/Students/zhoutao/code_updated/PFGR/runs/runX/checkpoint/coco_gru/results_coco_precomp_i2t.npy')
    parser.add_argument('--result2', default='/home/ubuntu/Students/zhoutao/code_updated/PFGR/runs/runX/checkpoint/coco_gru/results_coco_precomp_t2i.npy')
