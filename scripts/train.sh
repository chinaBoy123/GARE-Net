...
if [ $SPLIT = f30k_gru ];then
  ...
  LOGGER_NAME='/home/ubuntu/Students/zhoutao/code_updated/GARE-Net/runs/runX/log'
  MODEL_NAME='/home/ubuntu/Students/zhoutao/code_updated/GARE-Net/runs/runX/checkpoint/f30k_gru'
  nohup /home/ubuntu/miniconda3/envs/zhoutao/bin/python /home/ubuntu/Students/zhoutao/code_updated/GARE-Net/train.py \
...
if [ $SPLIT = f30k_bert ];then
  DATASET_NAME="f30k_precomp"
  LOGGER_NAME=/home/ubuntu/Students/zhoutao/code_updated/GARE-Net/runs/runX/log
  MODEL_NAME=/home/ubuntu/Students/zhoutao/code_updated/GARE-Net/runs/runX/checkpoint/f30k_bert
  nohup /home/ubuntu/miniconda3/envs/zhoutao/bin/python /home/ubuntu/Students/zhoutao/code_updated/GARE-Net/train.py \
...
if [ $SPLIT = coco_gru ];then
  ...
  LOGGER_NAME=/home/ubuntu/Students/zhoutao/code_updated/GARE-Net/runs/runX/log
  MODEL_NAME=/home/ubuntu/Students/zhoutao/code_updated/GARE-Net/runs/runX/checkpoint/coco_gru
  nohup /home/ubuntu/miniconda3/envs/zhoutao/bin/python /home/ubuntu/Students/zhoutao/code_updated/GARE-Net/train.py \
  --data_path=${DATA_PATH} --data_name=${DATASET_NAME} --text_enc_type=bigru \
  --vocab_path=${VOCAB_PATH} --logger_name=${LOGGER_NAME}/log --model_name=${MODEL_NAME} \
  --num_epochs=25 --lr_update=15 --learning_rate=5e-4 --precomp_enc_type=selfattention --workers=16 \
...
if [ $SPLIT = coco_bert ];then
  DATASET_NAME='coco_precomp'
  LOGGER_NAME=/home/ubuntu/Students/zhoutao/code_updated/GARE-Net/runs/runX/log
  MODEL_NAME=/home/ubuntu/Students/zhoutao/code_updated/GARE-Net/runs/runX/checkpoint/coco_bert
  nohup /home/ubuntu/miniconda3/envs/zhoutao/bin/python /home/ubuntu/Students/zhoutao/code_updated/GARE-Net/train.py \
  --data_path=${DATA_PATH} --data_name=${DATASET_NAME} --text_enc_type=bert \
  --vocab_path=${VOCAB_PATH} --logger_name=${LOGGER_NAME}/log --model_name=${MODEL_NAME} \
  --num_epochs=25 --lr_update=15 --learning_rate=5e-4 --workers=16 \
